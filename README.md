...
Test the config generated by the automated-backtesting tasks using a set of
logfiles dated from after the date of the generated automated-backtesting file.

```
make prove-backtesting CONFIG=BuyDropSellRecoveryStrategy.20220201.yaml LOGS='2022020?.log.gz'
```
