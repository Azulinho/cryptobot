...
class BuyOnRecoveryAfterDowntrendPeriodStrategy(Bot):
    """ Base Strategy Class"""
...
if __name__ == "__main__":
    try:
        ...
        elif cfg["STRATEGY"] == "BuyOnRecoveryAfterDowntrendPeriodStrategy":
            bot = BuyOnRecoveryAfterDowntrendPeriodStrategy(
                client, args.config, cfg
            ) # type: ignore
